...
// USART3 HC-05
#define UART_HC05_RX_PIN    GPIO_PIN_4
#define UART_HC05_TX_PIN    GPIO_PIN_3
#define UART_HC05_PORT      GPIOB
#define UART_HC05_AF_PORT   GPIO_AF4_USART5

#define __HAL_UART_HC05_RCC_ENA __HAL_RCC_USART5_CLK_ENABLE()
#define __HAL_UART_HC05_GPIO_RCC_ENA __HAL_RCC_GPIOB_CLK_ENABLE()
